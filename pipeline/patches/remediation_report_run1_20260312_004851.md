...
**Generated:** 2026-03-12 00:48:51
**Source:** `C:\Users\riddh\OneDrive\Documents\vuln-pipeline\pipeline\reports\Snyk_report.json`
...
**Description:** The ejs (aka Embedded JavaScript templates) package 3.1.6 for Node.js allows server-side template injection in settings[view options][outputFunctionName]. This is parsed as an internal option, and overwrites the outputFunctionName option with an arbitrary OS command (which is executed upon template ...
